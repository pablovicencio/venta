<?php
 ...
 //  }  
	...
	try{
			...
			$cod_barra_prod = stripcslashes ($_POST['codigoBarra']);
	        ...
	        $dao = new ProductoDAO('',$nom_prod,$uni_med_pro,$stock_min_prod,'',$vig_prod,$fec_cre,$usu_cre,$precio_bruto_prod,$iva_prod,$proc_ganan_prod, $precio_neto_prod,$id_prov_prod,$embalaje_prod,$cod_barra_prod,$familia_prod,$marca_prod,$precio_compra_neto,$porc_dscto_compra,$valor_dscto_compra,$precio_compra_neto_dscto,$iva_compra,$precio_total_compra,$valor_ganancia,$precio_venta_calc);
				
			$cre_prod = $dao->cre_prod();
			 
				if ($cre_prod>0){
					echo "Producto creado correctamente y agregado a la lista de ingreso!";    
