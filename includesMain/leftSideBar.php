                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-profile">
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Usuario Prueba</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#">Mis Datos </a></li>
                                <li><a href="#">Mis Accesos</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-folder-account"></i><span class="hide-menu">Clientes</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="#">Agregar Favoritos</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Usuarios</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="#">Listado </a></li>
                                <li><a href="index2.html">Agregar</a></li>
                                <li><a href="index3.html">Modificar</a></li>
                            </ul>
                        </li>
